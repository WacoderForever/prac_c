      ...
      000049 02 00 BE         [24]  359 	ljmp	_main
                                    ...
                                    367 ;------------------------------------------------------------
                                    368 ;i             Allocated to registers r7 
                                    369 ;j             Allocated to registers r5 r6 
                                    370 ;------------------------------------------------------------
                                    371 ;	blink.c:3: void delay(void) {
                                    372 ;	-----------------------------------------
                                    373 ;	 function delay
                                    374 ;	-----------------------------------------
      0000A8                        375 _delay:
                           ...
                           000001   382 	ar1 = 0x01
                           000000   383 	ar0 = 0x00
                                    384 ;	blink.c:5: for(i=0;i<100;i++)
      0000A8 7F 00            [12]  385 	mov	r7,#0x00
                                    386 ;	blink.c:6: for(j=0;j<1000;j++);
      0000AA                        387 00110$:
      0000AA 7D E8            [12]  388 	mov	r5,#0xe8
      0000AC 7E 03            [12]  389 	mov	r6,#0x03
      0000AE                        390 00105$:
      0000AE 1D               [12]  391 	dec	r5
      0000AF BD FF 01         [24]  392 	cjne	r5,#0xff,00130$
      0000B2 1E               [12]  393 	dec	r6
      0000B3                        394 00130$:
      0000B3 ED               [12]  395 	mov	a,r5
      0000B4 4E               [12]  396 	orl	a,r6
      0000B5 70 F7            [24]  397 	jnz	00105$
                                    398 ;	blink.c:5: for(i=0;i<100;i++)
      0000B7 0F               [12]  399 	inc	r7
      0000B8 BF 64 00         [24]  400 	cjne	r7,#0x64,00132$
      0000BB                        401 00132$:
      0000BB 40 ED            [24]  402 	jc	00110$
                                    403 ;	blink.c:7: }
      0000BD 22               [24]  404 	ret
                                    405 ;------------------------------------------------------------
                                    406 ;Allocation info for local variables in function 'main'
                                    407 ;------------------------------------------------------------
                                    408 ;	blink.c:9: void main(void) {
                                    409 ;	-----------------------------------------
                                    410 ;	 function main
                                    411 ;	-----------------------------------------
      0000BE                        412 _main:
                                    413 ;	blink.c:10: while(1) {
      0000BE                        414 00102$:
                                    415 ;	blink.c:11: P1 = 0xFF;
      0000BE 75 90 FF         [24]  416 	mov	_P1,#0xff
                                    417 ;	blink.c:12: delay();
      0000C1 12 00 A8         [24]  418 	lcall	_delay
                                    419 ;	blink.c:13: P1 = 0x00;
      0000C4 75 90 00         [24]  420 	mov	_P1,#0x00
                                    421 ;	blink.c:14: delay();
      0000C7 12 00 A8         [24]  422 	lcall	_delay
                                    423 ;	blink.c:16: }
      0000CA 80 F2            [24]  424 	sjmp	00102$
                                    425 	.area CSEG    (CODE)
                                    426 	.area CONST   (CODE)
                                    427 	.area XINIT   (CODE)
